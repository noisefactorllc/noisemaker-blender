 ...
 * spinBlur's rotation of a nm_fragment-position-derived offset, nothing here is
 * built from the nm_fragment's own coordinate relative to a center parameter.
 * Per the screen-truth doctrine (shared-context.md; verified for emboss's
 * analogous fixed nm_kernel-tap case in orientation-groundtruth.md), that means
...
void main() {
    ...
    // Gradient-to-slope scale: documented nm_constant. 8.0 turns a full 0..1
