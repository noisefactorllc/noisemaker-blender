...
void main() {
    ...
    vec4 s0 = nmTex(inputTex, uv + vec2(-texel.x, -texel.y));
    vec4 s1 = nmTex(inputTex, uv + vec2(0.0, -texel.y));
    vec4 s2 = nmTex(inputTex, uv + vec2(texel.x, -texel.y));
    vec4 s3 = nmTex(inputTex, uv + vec2(-texel.x, 0.0));
    vec4 s4 = nmTex(inputTex, uv);
    vec4 s5 = nmTex(inputTex, uv + vec2(texel.x, 0.0));
    vec4 s6 = nmTex(inputTex, uv + vec2(-texel.x, texel.y));
    vec4 s7 = nmTex(inputTex, uv + vec2(0.0, texel.y));
    vec4 s8 = nmTex(inputTex, uv + vec2(texel.x, texel.y));
