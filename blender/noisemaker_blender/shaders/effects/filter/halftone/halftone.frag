 ...
 * with a light 3x3 box blur at the CENTER of the current nm_fragment's
 * screen cell (not the nm_fragment itself) so a cell's dot has one flat
...
// carrying a runtime int dispatch through every nm_fragment.
#ifndef MODE
#define MODE 0
#endif
